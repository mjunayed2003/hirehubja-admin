...
const EarningsChart = ({ earningChart, period = "yearly", onPeriodChange }) => {
      ...
      <div className="flex-1 w-full min-h-[250px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={currentData} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
            ...
            <Area type="amount" dataKey="earnings" stroke="#43B948" strokeWidth={3} fill="url(#colorEarnings)" activeDot={{ r: 6, strokeWidth: 3, stroke: '#fff', fill: '#43B948' }} animationDuration={1000} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
