// pages/Main/UserApprovels/JobSeekerApprovals.jsx
      ...
      <div>
        <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
          <h2 className="text-xl font-bold text-gray-800">
            Job Seeker Registration Requests
          </h2>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="text-sm text-gray-700 divide-y divide-gray-50">
              {!isLoading && users.length === 0 ? (
                <tr>
                  <td colSpan={6} className="py-16 text-center text-gray-400 text-sm italic">
                  ...
                  return (
                    <tr key={row.id} className="hover:bg-[#FAFAFA] transition">
                      <td className="py-4 px-6 font-medium">
                        {row.jobSeekerProfile?.fullName || row.fullName || "—"}
                      </td>
